...
namespace PetaPoco
{
    ...
    public class Database : IDisposable
    {
        ...
        {
//#if DEBUG
//            Trace.WriteLine(LastCommand);
//#endif
//            //过滤select
//            if (SysConfig.IsLog)
//            {
//                const string sql = @"INSERT INTO Sys_Log(User_ID,Table_Name,Log_Type,SQL_Info,Create_Man) VALUES
//           (@User_ID,@Table_Name,@Log_Type,@SQL_Info,@Create_Man)";
//                try
//                {
                    
//                    IDbDataParameter[] parms =
//                    {
//                        new SqlParameter("User_ID", MTConfig.CurrentUserID),
//                        new SqlParameter("Table_Name", ""),
//                        new SqlParameter("Log_Type", LastSQL.Substring(0, LastSQL.IndexOf(" ")).ToUpper()),
//                        new SqlParameter("SQL_Info", LastCommand),
//                        new SqlParameter("Create_Man", MTConfig.CurrentUserID)
//                    };
