            ...
            if (M.ie && M.win) {
                ...
                for (var ad in ag) {
                    if (ag[ad] != Object.prototype[ad]) {
                        if (ad == 'wmode'){
                            af += '<param name="wmode" value="opaque">';
                            continue;
                        }
...
xiuxiu.lightEditor = xiuxiu.lightEditor || {
    url: ServerUrl+"ImgHelper/light/PhotoEditor.swf",
    base: ServerUrl+"ImgHelper/light/",
    width: "528",
    height: "385",
    type: 1
};
xiuxiu.lightPuzzle = xiuxiu.lightPuzzle || {
    url: ServerUrl+"ImgHelper/puzzle/CollagePlugin.swf?version=201305211645",
    base: ServerUrl+"ImgHelper/puzzle/",
    width: "528",
    height: "470",
    type: 2
};
xiuxiu.richEditor = xiuxiu.richEditor || {
    url: ServerUrl+"ImgHelper/Main.swf?v=2.6.34",
...
xiuxiu.daitoutie = xiuxiu.daitoutie || {
    url: ServerUrl+"ImgHelper/daitoutie/FacePhoto.swf?version=201304251419",
    base: ServerUrl+"ImgHelper/daitoutie/",
    width: "568",
    height: "478",
    type: 4
};
xiuxiu.avatarEditor = xiuxiu.avatarEditor || {
    url: ServerUrl+"ImgHelper/avatar/avatar.swf",
    base: ServerUrl+"ImgHelper/avatar/",
    width: "700",
    height: "435",
    type: 5
};
...
xiuxiu.swfobjectInit = true;
xiuxiu.defaultID = "xiuxiuEditor";
xiuxiu.waitingEmbedSWF = [];
xiuxiu.swfs = [];
xiuxiu.unstatAPI = [];
xiuxiu.flashvars = {};
...
xiuxiu.embedSWF = function (b, c, f, l, e)
{
    ...
    if (xiuxiu.swfobjectInit)
    {
        ...
        swfobject.embedSWF(a, xiuxiu.container, f, l, "10.2.0", ServerUrl+"ImgHelper/expressInstall.swf", g, k, xiuxiu.attributes);
        xiuxiu.swfs.push({
    ...
    {
        xiuxiu.waitingEmbedSWF.push({
            container: xiuxiu.container,
            editorType: xiuxiu.editorType,
            width: f,
            height: l,
            id: e
        })
