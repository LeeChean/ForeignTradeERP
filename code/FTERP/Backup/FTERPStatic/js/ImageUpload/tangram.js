// Copyright (c) 2009, tpbaidu Inc. All rights reserved.
// 
// Licensed under the BSD License
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at
// 
//      http:// tangram.tpbaidu.com/license.html
// 
...
*/
var T,
    tpbaidu = T = tpbaidu || { version: "1.5.0" };
tpbaidu.guid = "$tpbaidu$";
tpbaidu.$$ = window[tpbaidu.guid] = window[tpbaidu.guid] || { global: {} };

/**
* 使用flash资源封装的一些功能
* @namespace tpbaidu.flash
*/
tpbaidu.flash = tpbaidu.flash || {};

/**
* 操作dom的方法
* @namespace tpbaidu.dom 
*/
tpbaidu.dom = tpbaidu.dom || {};
...
tpbaidu.g = tpbaidu.G = tpbaidu.dom.g;


/**
* 操作数组的方法
* @namespace tpbaidu.array
*/

tpbaidu.array = tpbaidu.array || {};


/**
* 遍历数组中所有元素
* @name tpbaidu.array.each
* @function
* @grammar tpbaidu.array.each(source, iterator[, thisObject])
* @param {Array} source 需要遍历的数组
* @param {Function} iterator 对每个数组元素进行调用的函数，该函数有两个参数，第一个为数组元素，第二个为数组索引值，function (item, index)。
* @param {Object} [thisObject] 函数调用时的this指针，如果没有此参数，默认是当前遍历的数组
* @remark
* each方法不支持对Object的遍历,对Object的遍历使用tpbaidu.object.each 。
* @shortcut each
* @meta standard
*             
* @returns {Array} 遍历的数组
...
tpbaidu.each = tpbaidu.array.forEach = tpbaidu.array.each = function (source, iterator, thisObject) {
...
* @namespace tpbaidu.lang
*/
tpbaidu.lang = tpbaidu.lang || {};


/**
* 判断目标参数是否为function或Function实例
* @name tpbaidu.lang.isFunction
* @function
* @grammar tpbaidu.lang.isFunction(source)
* @param {Any} source 目标参数
* @version 1.2
* @see tpbaidu.lang.isString,tpbaidu.lang.isObject,tpbaidu.lang.isNumber,tpbaidu.lang.isArray,tpbaidu.lang.isElement,tpbaidu.lang.isBoolean,tpbaidu.lang.isDate
* @meta standard
* @returns {boolean} 类型判断结果
*/
tpbaidu.lang.isFunction = function (source) {
    return '[object Function]' == Object.prototype.toString.call(source);
};

/**
* 判断目标参数是否string类型或String对象
* @name tpbaidu.lang.isString
* @function
* @grammar tpbaidu.lang.isString(source)
* @param {Any} source 目标参数
* @shortcut isString
* @meta standard
* @see tpbaidu.lang.isObject,tpbaidu.lang.isNumber,tpbaidu.lang.isArray,tpbaidu.lang.isElement,tpbaidu.lang.isBoolean,tpbaidu.lang.isDate
*             
* @returns {boolean} 类型判断结果
*/
tpbaidu.lang.isString = function (source) {
    return '[object String]' == Object.prototype.toString.call(source);
};
tpbaidu.isString = tpbaidu.lang.isString;


/**
* 判断浏览器类型和特性的属性
* @namespace tpbaidu.browser
*/
tpbaidu.browser = tpbaidu.browser || {};


/**
* 判断是否为opera浏览器
* @property opera opera版本号
* @grammar tpbaidu.browser.opera
* @meta standard
* @see tpbaidu.browser.ie,tpbaidu.browser.firefox,tpbaidu.browser.safari,tpbaidu.browser.chrome
...
* opera后面的数字保持在9.80不变
*/
tpbaidu.browser.opera = /opera(\/| )(\d+(\.\d+)?)(.+?(version\/(\d+(\.\d+)?)))?/i.test(navigator.userAgent) ? +(RegExp["\x246"] || RegExp["\x242"]) : undefined;


/**
* 在目标元素的指定位置插入HTML代码
* @name tpbaidu.dom.insertHTML
* @function
* @grammar tpbaidu.dom.insertHTML(element, position, html)
...
*/
tpbaidu.dom.insertHTML = function (element, position, html) {
    element = tpbaidu.dom.g(element);
    var range, begin;
    if (element.insertAdjacentHTML && !tpbaidu.browser.opera) {
...
tpbaidu.insertHTML = tpbaidu.dom.insertHTML;

/**
* 操作flash对象的方法，包括创建flash对象、获取flash对象以及判断flash插件的版本号
* @namespace tpbaidu.swf
*/
tpbaidu.swf = tpbaidu.swf || {};


/**
* 浏览器支持的flash插件版本
* @property version 浏览器支持的flash插件版本
* @grammar tpbaidu.swf.version
* @return {String} 版本号
* @meta standard
*/
tpbaidu.swf.version = (function () {
    var n = navigator;
...
/**
* 操作字符串的方法
* @namespace tpbaidu.string
*/
tpbaidu.string = tpbaidu.string || {};


/**
* 对目标字符串进行html编码
* @name tpbaidu.string.encodeHTML
* @function
* @grammar tpbaidu.string.encodeHTML(source)
* @param {string} source 目标字符串
* @remark
* 编码字符有5个：&<>"'
* @shortcut encodeHTML
* @meta standard
* @see tpbaidu.string.decodeHTML
*             
* @returns {string} html编码后的字符串
*/
tpbaidu.string.encodeHTML = function (source) {
...
tpbaidu.encodeHTML = tpbaidu.string.encodeHTML;

/**
* 创建flash对象的html字符串
* @name tpbaidu.swf.createHTML
* @function
* @grammar tpbaidu.swf.createHTML(options)
* 
...
* 
* @see tpbaidu.swf.create
* @meta standard
* @returns {string} flash对象的html字符串
*/
tpbaidu.swf.createHTML = function (options) {
    options = options || {};
    var version = tpbaidu.swf.version,
        needVersion = options['ver'] || '6.0.0',
        vUnit1, vUnit2, i, k, len, item, tmpOpt = {},
        encodeHTML = tpbaidu.string.encodeHTML;
    for (k in options) {
        tmpOpt[k] = options[k];
    }
    options = tmpOpt;
...
/**
* 在页面中创建一个flash对象
* @name tpbaidu.swf.create
* @function
* @grammar tpbaidu.swf.create(options[, container])
* 
* @param {Object} 	options 					创建flash的选项参数
* @param {string} 	options.id 					要创建的flash的标识
* @param {string} 	options.url 				flash文件的url
...
* @meta standard
* @see tpbaidu.swf.createHTML,tpbaidu.swf.getMovie
*/
tpbaidu.swf.create = function (options, target) {
    options = options || {};
    var html = tpbaidu.swf.createHTML(options)
    ...
    tpbaidu.dom.insertHTML(target || document.body, 'beforeEnd', html);
};
/**
* 判断是否为ie浏览器
* @name tpbaidu.browser.ie
* @field
* @grammar tpbaidu.browser.ie
* @returns {Number} IE版本号
*/
tpbaidu.browser.ie = tpbaidu.ie = /msie (\d+\.\d+)/i.test(navigator.userAgent) ? (document.documentMode || +RegExp['\x241']) : undefined;

/**
* 移除数组中的项
* @name tpbaidu.array.remove
* @function
* @grammar tpbaidu.array.remove(source, match)
* @param {Array} source 需要移除项的数组
* @param {Any} match 要移除的项
* @meta standard
* @see tpbaidu.array.removeAt
*             
* @returns {Array} 移除后的数组
*/
tpbaidu.array.remove = function (source, match) {
...
/**
* 判断目标参数是否Array对象
* @name tpbaidu.lang.isArray
* @function
* @grammar tpbaidu.lang.isArray(source)
* @param {Any} source 目标参数
* @meta standard
* @see tpbaidu.lang.isString,tpbaidu.lang.isObject,tpbaidu.lang.isNumber,tpbaidu.lang.isElement,tpbaidu.lang.isBoolean,tpbaidu.lang.isDate
*             
* @returns {boolean} 类型判断结果
*/
tpbaidu.lang.isArray = function (source) {
...
/**
* 将一个变量转换成array
* @name tpbaidu.lang.toArray
* @function
* @grammar tpbaidu.lang.toArray(source)
* @param {mix} source 需要转换成array的变量
* @version 1.3
* @meta standard
* @returns {array} 转换后的array
*/
tpbaidu.lang.toArray = function (source) {
    if (source === null || source === undefined)
        return [];
    if (tpbaidu.lang.isArray(source))
        return source;
    if (typeof source.length !== 'number' || typeof source === 'string' || tpbaidu.lang.isFunction(source)) {
        return [source];
    }
    if (source.item) {
...
/**
* 获得flash对象的实例
* @name tpbaidu.swf.getMovie
* @function
* @grammar tpbaidu.swf.getMovie(name)
* @param {string} name flash对象的名称
* @see tpbaidu.swf.create
* @meta standard
* @returns {HTMLElement} flash对象的实例
*/
tpbaidu.swf.getMovie = function (name) {
    var movie = document[name], ret;
    return tpbaidu.browser.ie == 9 ?
    	movie && movie.length ?
    		(ret = tpbaidu.array.remove(tpbaidu.lang.toArray(movie), function (item) {
...
tpbaidu.flash._Base = (function () {
    ...
    */
    function _callFn(callQueue, target) {
        ...
        tpbaidu.each(callQueue, function (item) {
    ...
    */
    function _createFunName(fun) {
        ...
        if (tpbaidu.lang.isFunction(fun)) {
            name = _createString();
    ...
    */
    function _render(options) {
        ...
        tpbaidu.swf.create(options, container);

        return tpbaidu.swf.getMovie(options.id);
    };
        ...
        */
        me.render = function () {
            ...
            if (callBack.length > 0) {
                tpbaidu.each(callBack, function (funName, index) {
...
* @class
* @grammar tpbaidu.flash.imageUploader(options)
* @param {Object} createOptions 创建flash时需要的参数，请参照tpbaidu.swf.create文档
...
*/
tpbaidu.flash.imageUploader = tpbaidu.flash.imageUploader || function (options) {

    var me = this,
        options = options || {},
        _flash = new tpbaidu.flash._Base(options, [
            'selectFileCallback',
            'exceedFileCallback',
            'deleteFileCallback',
            'startUploadCallback',
...
/**
* 操作原生对象的方法
* @namespace tpbaidu.object
*/
tpbaidu.object = tpbaidu.object || {};


/**
* 将源对象的所有属性拷贝到目标对象中
* @author erik
* @name tpbaidu.object.extend
* @function
* @grammar tpbaidu.object.extend(target, source)
* @param {Object} target 目标对象
* @param {Object} source 源对象
* @see tpbaidu.array.merge
* @remark
* 
...
*/
tpbaidu.extend =
tpbaidu.object.extend = function (target, source) {
    for (var p in source) {
...
* @class
* @grammar tpbaidu.flash.fileUploader(options)
* @param {Object} options
* @config {Object} createOptions 创建flash时需要的参数，请参照tpbaidu.swf.create文档
...
*/
tpbaidu.flash.fileUploader = tpbaidu.flash.fileUploader || function (options) {
    var me = this,
        options = options || {};

    options.createOptions = tpbaidu.extend({
        wmod: 'transparent'
    }, options.createOptions || {});

    var _flash = new tpbaidu.flash._Base(options, [
        'selectFile',
        'exceedMaxSize',
        'deleteFile',
        'uploadStart',
    ...
    * */
    me.deleteFile = function (index, callBack) {
        ...
        tpbaidu.each(index, function (item) {
...
* @namespace tpbaidu.sio
*/
tpbaidu.sio = tpbaidu.sio || {};
...
*/
tpbaidu.sio._createScriptTag = function (scr, url, charset) {
...
* @param {HTMLElement} src script节点
*/
tpbaidu.sio._removeScriptTag = function (scr) {
...
* @name tpbaidu.sio.callByBrowser
* @function
* @grammar tpbaidu.sio.callByBrowser(url, opt_callback, opt_options)
...
* @meta standard
* @see tpbaidu.sio.callByServer
*/
tpbaidu.sio.callByBrowser = function (url, opt_callback, opt_options) {
    ...
    scr.onload = scr.onreadystatechange = function () {
        ...
        if ('undefined' == typeof readyState
            ...
            try {
                ...
                tpbaidu.sio._removeScriptTag(scr);
            }
        }
    };
    ...
    tpbaidu.sio._createScriptTag(scr, url, charset);
};

/**
* 通过script标签加载数据，加载完成由服务器端触发回调
* @name tpbaidu.sio.callByServer
* @function
* @grammar tpbaidu.sio.callByServer(url, callback[, opt_options])
* @param {string} url 加载数据的url.
...
* @meta standard
* @see tpbaidu.sio.callByBrowser
*/
tpbaidu.sio.callByServer = /**@function*/function (url, callback, opt_options) {
    var scr = document.createElement('SCRIPT'),
        prefix = 'bd__cbs__',
        callbackName,
        callbackImpl,
    ...
    if (tpbaidu.lang.isFunction(callback)) {
        callbackName = prefix + Math.floor(Math.random() * 2147483648).toString(36);
        window[callbackName] = getCallBack(0);
    } else if (tpbaidu.lang.isString(callback)) {
...
* @function
* @grammar tpbaidu.sio.log(url)
* @param {string} url 要发送的地址.
* @author: int08h,leeight
*/
tpbaidu.sio.log = function (url) {
    var img = new Image(),
